        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-lg">
                <div class="bg-gray-800 rounded-lg shadow-xl p-6 border border-gray-700">
                    <form method="POST" action="{{ route('permisos.update', $permiso->id) }}" class="space-y-5">
                        @csrf @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $permiso->nombre) }}" required
                        ...
                        <div>
                            <label for="descripcion" class="block text-sm font-bold mb-2 uppercase tracking-wider" style="color: #ffffff !important;">
                                Descripción
                            </label>

                            <textarea id="descripcion" name="descripcion" rows="3"
                                      class="w-full rounded-lg px-3 py-2 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('descripcion') border-red-400 @enderror"
                                      style="background-color: #374151 !important; border: 1px solid #4b5563 !important; color: #ffffff !important;"
                                      placeholder="Ej: Permite la creación y modificación de usuarios...">{{ old('descripcion', $permiso->descripcion) }}</textarea>
