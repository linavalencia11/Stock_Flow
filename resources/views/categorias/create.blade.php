...
<div class="max-w-lg">
    <div class="bg-gray-800 rounded-lg shadow-xl p-6 border border-gray-700">
        <form method="POST" action="{{ route('categorias.store') }}" class="space-y-5">
            ...
            <div>
                <label for="nombre" class="block text-sm font-medium text-white mb-1">Nombre</label>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('categorias.index') }}" class="text-sm text-gray-300 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-gray-800">Cancelar</a>
            </div>
        </form>
    </div>
        </div>
