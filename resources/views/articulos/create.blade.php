...
<div class="max-w-xl">
    <div class="bg-gray-800 rounded-lg shadow-xl p-6 border border-gray-700">
        <form method="POST" action="{{ route('articulos.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div>
                <label for="categoria_id" class="block text-sm font-medium text-gray-200 mb-1">Categoría</label>
                <select id="categoria_id" name="categoria_id" required
                        class="w-full bg-gray-700 border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-100 focus:outline-none
            ...
            <div>
                <label for="estado" class="block text-sm font-medium text-gray-200 mb-1">Estado</label>
            ...
            <div>
                <label for="ubicacion" class="block text-sm font-medium text-gray-200 mb-1">Ubicación</label>
            ...
            <div>
                <label for="foto" class="block text-sm font-medium text-gray-200 mb-1">Foto (opcional)</label>
                <input type="file" id="foto" name="foto" accept="image/*"
                       class="w-full text-sm text-gray-400 file:mr-3 file:py-1.5 file:px-4 file:rounded-lg
                              file:border-0 file:text-sm file:font-medium file:bg-indigo-600 file:text-white
                              hover:file:bg-indigo-700 @error('foto') border-red-400 @enderror">
